...
<body>
    <a href="create.php">
        <button type="button">Agregar Médico</button>
    </a>
        ...
        <tbody>
            ...
            while($row = mysqli_fetch_array($result_medico)){?>
                <tr>
                    ...
                    <td><?php echo $row['horario_trabajo']?></td>
                    <td>
                        <a href="delete.php?id=<?php echo $row['id_medico']?>">
                            <button type="button" >Eliminar</button>
                        </a>
                        <a href="update.php?id=<?php echo $row['id_medico']?>">
